...
public class JavaNCSSOutputParseTest {
	...
	public void shouldParseAListWithJavaNCSSXmlOutput() {
		...
		assertEquals("br.com.caelum.revolution.analyzers.Analyzer", parsedStuff.getObjects().get(0).getName());
		assertEquals(2, parsedStuff.getObjects().get(0).getNcss());
		assertEquals("br.com.caelum.revolution.analyzers.AnalyzerFactory", parsedStuff.getObjects().get(1).getName());
